...
public class ObjectFactory {
    ...
    private final static QName _SourceUser_QNAME = new QName("http://jewzaam.org/source/1", "SourceUser");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jewzaam.org/source/1", name = "SourceUser")
